...
function Reset:CreateResetButtons(parent)
	...
	local button = TSMAPI.GUI:CreateButton(frame, 22, "TSMAuctioningResetBuyoutButton", true)
	...
	local button = TSMAPI.GUI:CreateButton(frame, 18, "TSMAuctioningResetCancelButton", true)
	...
	local button = TSMAPI.GUI:CreateButton(frame, 18, "TSMAuctioningResetStopButton", true)
