...
function private:CreateButtons(parent)
	...
	local button = TSMAPI.GUI:CreateButton(frame, 22, "TSMAuctioningPostButton", false)
	...
	local button = TSMAPI.GUI:CreateButton(frame, 22, "TSMAuctioningCancelButton", false)
	button:SetPoint("TOPLEFT")
	button:SetWidth(80)
	button:SetHeight(height)
...
function GUI:CreateSelectionFrame(parent)
	...
	local postBtn = TSMAPI.GUI:CreateButton(frame, 16, "_TSMStartPostScanButton", true)
	...
	local cancelBtn = TSMAPI.GUI:CreateButton(frame, 16, "_TSMStartCancelScanButton", true)
